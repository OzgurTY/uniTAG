        ...
        try {
            ...
            if (status === 'completed') {
                ...
                if (rideSnap.exists()) {
                    ...
                    // Tüm yolculara bildirim at
                    data.passengers.forEach(async (pId: string) => {
                        await NotificationService.sendNotification(
                            pId,
                            'Yolculuk İptal',
                            'Katıldığınız yolculuk sürücü tarafından iptal edildi.',
                            'error',
                            rideId
                        );
                    });
